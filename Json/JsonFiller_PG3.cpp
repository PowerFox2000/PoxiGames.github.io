...
{
    int seasonNumber = 9;
    const std::string jsonFile = "JsonBackups/PG3S3.json";
    const std::string toJson = "JsonBackups/PG3S4.json";
    std::vector<player> players;

    OpenXLSX::XLDocument doc;
    doc.open("Excel data/PoxiGames3Season4.xlsx");
    ...
    bool hasBattle = true;
    bool hasHeist = true;
    bool hasLavarun = false;
    bool hasPirates = true;
    bool hasDontFall = true;
    bool hasSpleef = true;
    bool hasExtraction = true;
